...
\headerbox{Find more}{name=links, column=4, above=bottom, span=1}{
    \begin{minipage}{\textwidth}
        \centering
        \includegraphics[height=13.5em]{onca}
    \end{minipage}
...
\headerbox{Actions}{name=actions, column=2, below=elements, span=2}{
    \begin{minipage}{\textwidth}
        \centering
...
\headerbox{Screenshots}{name=screenshot, column=1, below=motivation, span=1}{
    \begin{minipage}{\textwidth}
        \centering
        \vskip 0.2em%
