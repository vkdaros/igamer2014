...
\headerbox{Educational aspects}{name=education, column=0, row=0, span=1}{
    Existing approaches using entertainment to motivate learning computer
    programming are usually too focused on direct input of code.

    \vskip 1em%
    The main goal of \gamename{ }is not to teach how to write code, but instead
    to promote the development of skills required for solving
    computational problems and useful for any human task in which logical
    ...
    \vskip 1em%
    Further more the trial and error aspect of the game requires the players to:
    (i) follow the execution steps, (ii) understand where are the pieces causing
    undesired behavior, and (iii) fix the problems. \textbf{This is essentially
    debugging}.
}

\headerbox{Targets}{name=target, column=0, below=education, span=1}{
...
\headerbox{Links}{name=links, column=4, below=end, span=1}{
