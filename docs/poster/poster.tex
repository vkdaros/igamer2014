...
% Autores e nome da universidade.
{
    ...
    \begin{minipage}{0.94\textwidth}
        ...
        \begin{minipage}{0.49\textwidth}
            ...
            \parbox[t][2.2em][b]{0.44\textwidth}{
                \includegraphics[height=5.5em]{LIDET-logo}
            }
        \end{minipage}
    \end{minipage}
...
\headerbox{Educational aspects}{name=education, column=0, row=0, span=1}{
    ...
    \end{enumerate}
    \textbf{This is procedure is to debug}.
}

\headerbox{Tangential learning}{name=target, column=0, above=bottom, span=1}{
    ...
    \begin{description}[noitemsep,topsep=0pt,parsep=0pt]
        \item[Geography:] \hfill\\
            Find Brazilian cities on the map
        \item[Biology:] \hfill\\
            Discover animal species of various Brazilian regions
    \end{description}
}
...
\headerbox{Find more}{name=links, column=4, above=bottom, span=1}{
    \begin{minipage}{\textwidth}
        \centering
        \includegraphics[height=11.75em]{onca}
    \end{minipage}
