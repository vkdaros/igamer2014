...
% Título do pôster.
{
    ...
    programming statements, the game foster computational thinking. %TODO: logical bla
    \end{minipage}
}
...
\headerbox{Educational aspects}{name=education, column=0, row=0, span=1}{
    ...
    \end{enumerate}
    \textbf{This procedure is to debug}.
}

\headerbox{Tangential learning}{name=learning, column=0, above=bottom, span=1}{
...
\headerbox{Find more}{name=links, column=4, above=bottom, span=1}{
...
\headerbox{Game elements}{name=elements, column=1, aligned=education, span=3}{
    \begin{multicols}{2}
...
\headerbox{Actions}{name=actions, column=1, below=elements, span=2}{
    \begin{minipage}{\textwidth}
        \centering
...
%
%\headerbox{Bola}{name=bola, column=1, below=elements, span=2}{
%    \begin{minipage}{0.5\textwidth}
%        \centering
%        \includegraphics[width=\textwidth]{screen}
%    \end{minipage}
